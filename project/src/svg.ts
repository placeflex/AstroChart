...
class SVG {
  ...
  constructor(
    ...
    console.log("SVG settings", settings);
  ...
  pathMove({ position, name, color }: any) {
    const pathWay = document
      ?.querySelector(`#paper-astrology-radix-signs-${position}`)
      ?.getAttribute("d");
    ...
    path.setAttribute("d", String(pathWay));
    ...
    textPath.setAttribute("startOffset", "81.5%");
  ...
  aries(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_ARIES"];
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "ARIES",
        color: this.settings.COLOR_ARIES_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_ARIES_TEXT_COLOR);
  ...
  taurus(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_TAURUS"];
    const wrapper = document.createElementNS(
      this.context.root.namespaceURI,
      "g"
    );
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "TAURUS",
        color: this.settings.COLOR_TAURUS_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_TAURUS_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  gemini(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_GEMINI"];
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "GEMINI",
        color: this.settings.COLOR_GEMINI_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_GEMINI_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  cancer(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_CANCER"];
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "CANCER",
        color: this.settings.COLOR_CANCER_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_CANCER_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  leo(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_LEO"];
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "LEO",
        color: this.settings.COLOR_LEO_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_LEO_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  virgo(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_VIRGO"];
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "VIRGO",
        color: this.settings.COLOR_VIRGO_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_VIRGO_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  libra(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_LIBRA"];
    const wrapper = document.createElementNS(
      this.context.root.namespaceURI,
      "g"
    );
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "LIBRA",
        color: this.settings.COLOR_LIBRA_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_LIBRA_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  scorpio(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_SCORPIO"];
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "SCORPIO",
        color: this.settings.COLOR_SCORPIO_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_SCORPIO_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  sagittarius(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_SAGITTARIUS"];
    const wrapper = document.createElementNS(
      this.context.root.namespaceURI,
      "g"
    );
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "SAGITTARIUS",
        color: this.settings.COLOR_SAGITTARIUS_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_SAGITTARIUS_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  capricorn(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_CAPRICORN"];
    const wrapper = document.createElementNS(
      this.context.root.namespaceURI,
      "g"
    );
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "CAPRICORN",
        color: this.settings.COLOR_CAPRICORN_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_CAPRICORN_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  aquarius(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_AQUARIUS"];
    const wrapper = document.createElementNS(
      this.context.root.namespaceURI,
      "g"
    );
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "AQUARIUS",
        color: this.settings.COLOR_AQUARIUS_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_AQUARIUS_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  pisces(x: number, y: number): Element {
    ...
    x = Math.round(x + xShift * this.settings.SYMBOL_SCALE);
    y = Math.round(y + yShift * this.settings.SYMBOL_SCALE);
    const pos = this.settings.SIGNS_POSITIONS["SYMBOL_PISCES"];
    const wrapper = document.createElementNS(
      this.context.root.namespaceURI,
      "g"
    );
    ...
    if (this.settings.VARIANT == "text") {
      const { node, path } = this.pathMove({
        position: pos,
        name: "PISCES",
        color: this.settings.COLOR_PISCES_TEXT_COLOR,
      });
    ...
    node.setAttribute("stroke", this.settings.COLOR_PISCES_TEXT_COLOR);
    node.setAttribute("stroke-width", this.settings.SIGNS_STROKE.toString());
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  ascendant(x: number, y: number): Element {
    ...
    node.setAttribute(
      "stroke-width",
      (this.settings.SYMBOL_AXIS_STROKE * this.settings.SYMBOL_SCALE).toString()
    );
    node.setAttribute("fill", "none");
  ...
  text(
    ...
    if (this.settings.DISABLED_EXTRA_FIELDS) {
      return text;
    }
